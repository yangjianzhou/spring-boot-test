...
//
//    /**
//     * Gets the org.unitils.spring bean with the given name. The given test instance, by using {@link SpringApplicationContext},
...
//
//    /**
//     * Gets the org.unitils.spring bean with the given type. The given test instance, by using {@link SpringApplicationContext},
//     * determines the application context in which to look for the bean.
...
//        // Verify if the org.unitils.spring testcontext framework is used, and if an ApplicationContext has been configured
...
//
//    /**
//     * Verify that the org.unitils.spring testcontext framework and unitils are not used together in an incompatible
//     * way: Check if not using the unitils core module system, and org.unitils.spring's @ContextConfiguration annotation for
...
//    				+ " but you're not using one of org.unitils.spring's base classes to execute your test");
//    	}
//	}*/
//
//
...
//
//        /**
//         * @see org.unitils.core.TestListener#afterTestTearDown(Object, Method)
//         */
//        @Override

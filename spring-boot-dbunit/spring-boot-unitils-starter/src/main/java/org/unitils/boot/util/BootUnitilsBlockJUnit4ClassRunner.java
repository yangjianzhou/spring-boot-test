 ...
 */
public class BootUnitilsBlockJUnit4ClassRunner extends BlockJUnit4ClassRunner {
    ...
    static {
        ...
        Method method = ReflectionUtils.findMethod(BootUnitilsBlockJUnit4ClassRunner.class, "withRules",FrameworkMethod.class, Object.class, Statement.class);
     ...
     */
    public BootUnitilsBlockJUnit4ClassRunner(Class<?> clazz) throws InitializationError {
        super(clazz);
